namespace VBWebBrowserNew.My
{
    ...
    internal sealed class MyProject
    {
        ...
        {
            public VBWebBrowserNew.Form1 m_Form1;
            [ThreadStatic]
            private static Hashtable m_FormBeingCreated;

            [DebuggerHidden]
            private static T Create__Instance__<T>(T Instance) where T: Form1, new()
            {
                T local;
            ...
            [DebuggerHidden]
            private void Dispose__Instance__<T>(ref T instance) where T: Form1
            {
                instance.Dispose();
                instance = default(T);
            }
            ...
            public VBWebBrowserNew.Form1 Form1
            {
                [DebuggerNonUserCode]
                get
                {
                    this.m_Form1 = Create__Instance__<VBWebBrowserNew.Form1>(this.m_Form1);
                    return this.m_Form1;
                }
                [DebuggerNonUserCode]
                set
                {
                    if (value != this.m_Form1)
                    {
                        ...
                        this.Dispose__Instance__<VBWebBrowserNew.Form1>(ref this.m_Form1);
                    }
                }
            }
        }
